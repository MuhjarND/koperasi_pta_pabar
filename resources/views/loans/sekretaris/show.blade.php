...
@section('subtitle', 'Review dokumen dan validasi awal sebelum diteruskan.')
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3>Keputusan Sekretaris</h3>
                </div>
            </div>
            <form method="post" action="{{ route('sekretaris.loans.review', $loan->id) }}" class="form-grid">
                @csrf
                ...
                <div class="form-control">
                    ...
                    <textarea name="note" placeholder="Tambahkan catatan review"></textarea>
                </div>
