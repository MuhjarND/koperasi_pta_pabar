...
@section('subtitle', 'Validasi kemampuan kas sebelum diteruskan ke ketua.')
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3>Keputusan Bendahara</h3>
                </div>
            </div>
            <form method="post" action="{{ route('bendahara.loans.approve', $loan->id) }}" class="form-grid">
                @csrf
                <div class="form-control">
                    <label>Keputusan</label>
                    <select name="decision" required>
                        <option value="approve">Setujui & Teruskan</option>
                        <option value="reject">Tolak</option>
                    </select>
                </div>
                <div class="form-control">
                    <label>Catatan (opsional)</label>
                    <textarea name="note" placeholder="Tambahkan catatan bendahara"></textarea>
                </div>
